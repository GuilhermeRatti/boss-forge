...
- **M3 IMPLEMENTADO em 2026-07-04** com decisões de UI delegadas pelo usuário; **aguardando teste/feedback** (fluxo combinado: sem revisão prévia de design — ele testa o resultado e apara). Design em `docs/design/m3-covil.md`; pesquisa em `docs/research/2026-07-04-m3-lair-fontes-instaladas.md` (dnd5e NÃO tem integração de combate para covil — os gatilhos de iniciativa/combate são nossos; o +1 de `lair.inside` é nativo).
...
- **M3 — Covil** (implementado em 2026-07-04, aguardando teste/feedback do usuário): prompt iniciativa 20 (2014) e toggle `lair.inside` (2024) com cenas marcáveis como covil e reversão pós-combate.
