...
- **M2 ABERTO em 2026-07-04 com aval do usuário.** Fluxo igual ao M1: pesquisa na fonte instalada (midi-qol 13.0.63 em `Data\modules\midi-qol`, bundle + sourcemap) → design doc → revisão do usuário → implementação.
